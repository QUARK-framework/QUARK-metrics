...
This template includes a GitHub action that prepares the newly created plugin for use with quark by exchanging some placeholders like `QUARK-metrics`, based on the name you have given your plugin.
